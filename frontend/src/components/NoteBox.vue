  ...
  <div class="col-6">
    <div class="card-body border border-warning-subtle border-4 grid gap-3 m-2 p-2">
      <div class="row">
        ...
        <div class="col-4">
          <button type="button" class="btn" @click="deleteNote" data-trigger="hover">
          ...
          <button type="button" class="btn" data-trigger="hover">
          ...
          <button v-if="note.isActive" type="button" @click="changeState" class="btn" data-trigger="hover">
          ...
          <button v-else type="button" @click="changeState" class="btn" data-trigger="hover">
...
export default {  
  ...
  methods: {
    ...
    async deleteNote(){
      axiosService.delete("/notes/"+this.note.id,
      {   
        headers: {
          Authorization: `${localStorage.getItem("token")}`,
        },
